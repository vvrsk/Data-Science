...
*get var list;
data indep;                                                                   
set  resp_data2 (drop=resp seqnum moshoo mostyp);        /*resp seqnum*/                                         
run;                                                                          
...
model resp=PWAPAR2;
title "PWAPAR2 Linear";
run;

proc logistic data=resp_data4 descending;
model resp=PWAPAR2 PWAPAR2sq;
title "PWAPAR2sq Quad";
run;


proc logistic data=resp_data4 descending;
model resp=MGODRK2;
title "MGODRK2 Linear";
run;

proc logistic data=resp_data4 descending;
model resp=MGODRK2 MGODRK2sq;
title "MGODRK2sq Quad";
run;

proc logistic data=resp_data4 descending;
model resp=MGODPR2;
title "MGODPR2 Linear";
run;

proc logistic data=resp_data4 descending;
model resp=MGODPR2 MGODPR2sq;
title "MGODPR2sq Quad";
run;

proc logistic data=resp_data4 descending;
model resp=MFALLE2;
title "MFALLE2 Linear";
run;

proc logistic data=resp_data4 descending;
model resp=MFALLE2 MFALLE2sq;
title "MFALLE2sq Quad";
run;

proc logistic data=resp_data4 descending;
model resp=MFALLE2 MFALLE2sq MFALLE2cu;
title "MFALLE2cu Cube";
run;

proc logistic data=resp_data4 descending;
model resp=MOPLHO2;
title "MOPLHO2 Linear";
run;

proc logistic data=resp_data4 descending;
model resp=MOPLHO2 MOPLHO2sq;
title "MOPLHO2sq Quad";
run;

proc logistic data=resp_data4 descending;
model resp=MSKA2;
title "MSKA2sq Linear";
run;

proc logistic data=resp_data4 descending;
model resp=MSKA2 MSKA2sq;
title "MSKA2sq Quad";
run;

proc logistic data=resp_data4 descending;
model resp=MSKA2 MSKA2sq MSKA2cu;
title "MSKA2sq Cubic";
run;
...
proc logistic data=resp_data4 descending;
model resp=MSKB22;
title "MSKB22sq Linear";
run;

proc logistic data=resp_data4 descending;
model resp=MSKB22 MSKB22sq;
title "MSKB22sq Quad";
run;

proc logistic data=resp_data4 descending;
model resp=MAUT12;
title "MAUT12sq Linear";
run;
...
proc logistic data=resp_data4 descending;
model resp=MINKGE2;
title "MINKGE2sq Linear";
run;

proc logistic data=resp_data4 descending;
model resp=MINKGE2sq;
title "MINKGE2sq Quad";
run;

proc logistic data=resp_data4 descending;
model resp=MINKGE2cu;
title "MINKGE2cu cubic";
run;
...
proc logistic data=resp_data4 descending;
model resp=mgemom mgemomcu;
title "Mgemom cubic Model";
run;
title;
